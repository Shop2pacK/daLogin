<?php
    ...
    // TIMEOUT
    function timeoutCheck($limit) {

        $_SESSION['sess_time'] = $_SERVER['REQUEST_TIME'];

        if (isset($_SESSION['LAST_ACTIVITY']) && ($_SESSION['sess_time'] - $_SESSION['LAST_ACTIVITY']) > $limit) {
        ...
        $_SESSION['LAST_ACTIVITY'] = $_SESSION['sess_time'];
